...
const translations = {
    en: {
        ...
        policeStations: {
            ...
            "Office of Superintendent of Police": "Office of Superintendent of Police",
    ...
    hi: {
        ...
        policeStations: {
            ...
            "Office of Superintendent of Police": "पुलिस अधीक्षक कार्यालय",
            "Rupjhar": "रूपझर",
            "Tirodi": "तिरोड़ी",
...
async function generateCertificate(name, certId, district, village, policeStation = '') {
   ...
   const logoY = 45;
    ...
    ctx.fillText('सफलतापूर्वक नशा मुक्ति की शपथ ग्रहण की है तथा', w / 2, 495);
    ctx.fillText('नशीले पदार्थों से दूर रहने, स्वस्थ जीवनशैली अपनाने और नशा-मुक्त समाज के निर्माण में सक्रिय सहयोग प्रदान करने का संकल्प लिया है।', w / 2, 518);
